...
import 'package:expense_tracker/features/statistics/domain/logic/monthly_spending_trend_calculator.dart';
...
class MonthlySpendingTrendNotifier extends AsyncNotifier<MonthlySpendingTrendSeries> {
  @override
  Future<MonthlySpendingTrendSeries> build() async {
    ...
    return MonthlySpendingTrendCalculator.build(
      period: period,
...
final monthlySpendingTrendProvider =
    AsyncNotifierProvider<MonthlySpendingTrendNotifier, MonthlySpendingTrendSeries>(
  MonthlySpendingTrendNotifier.new,
);
