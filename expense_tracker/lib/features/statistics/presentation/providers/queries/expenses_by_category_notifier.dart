...
class ExpensesByCategoryNotifier extends AsyncNotifier<ExpensesByCategorySeries> {
  @override
  Future<ExpensesByCategorySeries> build() async {
    ...
    final records = await transactionsRepository.getExpensesByCategoryInPeriod(
...
final expensesByCategoryProvider =
    AsyncNotifierProvider<ExpensesByCategoryNotifier, ExpensesByCategorySeries>(
  ExpensesByCategoryNotifier.new,
);
