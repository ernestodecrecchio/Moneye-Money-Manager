...
class CategoryAccountBreakdownSection extends ConsumerWidget {
...
class CategoryAccountBreakdownBarChart extends ConsumerWidget {
  const CategoryAccountBreakdownBarChart({super.key, required this.series});
...
class _AccountBreakdownRow extends StatelessWidget {
  ...
  final AccountBreakdownEntry entry;
  ...
  Widget build(BuildContext context) {
    final colors = context.appColors;
    final accountColor = entry.account.color;
        ...
        Row(
          ...
          children: [
            IconItem(
              ...
              iconPath: entry.account.iconPath,
