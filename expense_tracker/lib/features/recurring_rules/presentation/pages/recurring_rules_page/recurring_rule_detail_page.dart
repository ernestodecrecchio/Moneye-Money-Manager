...
class RecurringRuleDetailPage extends ConsumerWidget {
  ...
  Widget _buildRuleHeader(BuildContext context, WidgetRef ref, Category? category,
      Account? account, AppLocalizations appLocalizations, RecurringRule currentRule) {
