  ...
  Future<String> _generateBackupJson() async {
    ...
    final backupData = {
      ...
      'data': {
        ...
        'recurringRules': recurringRules.map((e) => RecurringRuleMapper.toJson(e)).toList(),
        'transactions': transactions.map((e) => TransactionMapper.toJson(e)).toList(),
      },
    };
  ...
  Future<bool> importDatabase() async {
    ...
    await db.transaction((txn) async {
      ...
      for (var transJson in transactionsJson) {
        await txn.insert(
            transactionsTable, transJson as Map<String, dynamic>);
      }
    });
